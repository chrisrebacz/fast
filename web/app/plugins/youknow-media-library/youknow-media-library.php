<?php
/**
Plugin Name: YouKnow Media Library
Description: Fork from Matthais Gunter's Real Media Library plugin to organize the media library in a nice way.
Author: Chris Rebacz & Matthias Günter
Version: 3.4.5
Licence: GPLv2
*/
    ...
    if (!function_exists("rml_skip_php_admin_notice")) {
        function rml_skip_php_admin_notice() {
            ...
            <div class="notice notice-error">
                <p><strong>YouKnow Media Library</strong> could not be initialized because you need minimum PHP version <?php echo RML_MIN_PHP_VERSION; ?> ... you are running: <?php echo phpversion(); ?>.
