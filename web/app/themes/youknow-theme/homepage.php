...
if (youknow_is_regional_role($userrole)) {
    ...
    if (! empty($allowed) && is_array($allowed)) {
        $args['post_type'] = ['post', 'tiots', 'iefs_comm'];
...
$mpargs = [
    'post_type' => youknow_departments($department, true),
    'posts_per_page' => 5,
    'orderby' => 'modified',
    'order' => 'DESC',
    'post_status' => 'publish',
];
$mpq = new WP_Query($mpargs);
    ...
    <div class="row animated fadeIn m-t-40">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="dlh-article-list dlh-article-container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if ($mpq->have_posts()) : while ($mpq->have_posts()) : $mpq->the_post(); ?>
                        <div class="dln-box float-e-margins dlh-article">
                            <div class="dln-box-content">
                                <p class="dlh-article-metadata"><span class="posttype"><?php echo $department; ?></span> | <span class="date"><?php echo get_the_modified_date(); ?></span></p>
                                <h2 class="dlh-article-title"><a href="<?php the_permalink(); ?>"><?php youknow_trim_title(get_the_title()); ?></a></h2>
                                <p class="dlh-article-excerpt"><?php the_excerpt(); ?></p>
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <div class="dln-box float-e-margins dlh-article clearfix text-center">
                            <div class="btn btn-warning btn-sm"><a class="read-more-btn" href="<?php echo home_url().'/iefs'; ?>">View All M&Ps</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="dlh-article-list dlh-article-container">
                ...
                <div class="row">
                    ...
                    if (have_rows('categories')) :
                        ...
                        ?>
                            <div class="row">
                                <?php foreach ($rows as $row) : the_row(); ?>
                                    <div class="col-md-12">
